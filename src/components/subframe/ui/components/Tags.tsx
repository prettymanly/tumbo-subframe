...
/*
 * Documentation:
 * Tags — https://app.subframe.com/library?component=Tags_68086342-8ea9-455f-ae53-bd3d1844870a
 */
...
interface TagsRootProps extends React.HTMLAttributes<HTMLDivElement> {
...
const TagsRoot = React.forwardRef<HTMLDivElement, TagsRootProps>(
  function TagsRoot(
    {
      variant = "brand",
      icon = null,
    ...
    return (
      <div
        className={SubframeUtils.twClassNames(
          "group/68086342 flex h-6 items-center gap-1 rounded-md border border-solid border-brand-100 bg-brand-100 px-2",
          {
